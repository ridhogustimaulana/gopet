                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" id="longitude" class="form-control" name="longitude" value="{{ $petshop->longitude }}">
                                            <input type="hidden" id="latitude" class="form-control" name="latitude" value="{{ $petshop->latitude }}">
                                        </div>
                                    </div>
                                </div>
