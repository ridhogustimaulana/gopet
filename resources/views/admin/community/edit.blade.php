    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0">Form Edit Community</h3>
                <ol class="breadcrumb">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <input name="image" data-max-file-size="1M" type="file"
                                                               ...
                                                               data-default-file="{{ asset('images/' . $community->image) }}"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input name="name" required type="text" id="name" class="form-control"
                                                   placeholder="Enter community name" value="{{ $community->name }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" class="form-control" cols="30"
                                                      rows="10"
                                                      placeholder="Enter community description">{{ $community->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="leader" required type="text" id="leader" class="form-control"
                                                   placeholder="Enter leader" value="{{ $community->leader }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="phone" id="phone" class="form-control"
                                                       placeholder="Enter contact person" value="{{ $community->phone }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input name="address" required type="text" id="address" class="form-control"
                                                   placeholder="Enter address" value="{{ $community->address }}">
                                        </div>
                                    </div>
                                </div>
