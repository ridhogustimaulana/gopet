(function($) {
  "use strict";
    ...
    TweenMax.from(".center-content-image", 1, { x:'80', opacity: 0, ease: Power1.easeOut});
    TweenMax.from(".top-content-image", 1.5, { y:'-80', opacity: 0, ease: Power1.easeOut});
    TweenMax.from(".bottom-content-image", 1.8, { y:'80', opacity: 0, ease: Power1.easeOut});
    ...
    addScene("#section4", new TweenMax.from(".section4 #pr-item5", 1, {
        opacity: 0,
        y: 100,
        ease: Power1.easeOut
    }).delay(.4)),
    addScene("#section4", new TweenMax.from(".section4 #pr-item6", 1.5, {
        opacity: 0,
        y: 100,
        ease: Power1.easeOut
    }).delay(.5)),
    addScene("#section4", new TweenMax.from(".section4 #pr-item7", 1.8, {
        opacity: 0,
        y: 100,
        ease: Power1.easeOut
    }).delay(.6)),
    addScene("#section4", new TweenMax.from(".section4 #pr-item8", 2, {
        opacity: 0,
        y: 100,
        ease: Power1.easeOut
    }).delay(.7));
  ...
  addScene("#section6", new TweenMax.from(".sg-testimonial-inner", 2.1, {
      opacity: 0,
      y: 100,
      ease: Power1.easeOut
  }).delay(.6)),
  ...
  console.log("Loading scene 7"),
  addScene("#section7", new TweenMax.from(".section7 .ev-content-title span", 1, {
      opacity: 0,
      y: 100,
      ease: Power1.easeOut
  }).delay(.5)),
  addScene("#section7", new TweenMax.from(".section7 .ev-content-title h3", 1.2, {
      opacity: 0,
      y: 100,
      ease: Power1.easeOut
  }).delay(.6)),
  addScene("#section7", new TweenMax.from(".section7 .ev-content-title p", 1.4, {
      opacity: 0,
      y: 100,
      ease: Power1.easeOut
  }).delay(.9)),
  addScene("#section7", new TweenMax.from(".section7 #price-item1", 1.5, {
      opacity: 0,
      y: 100,
      ease: Power1.easeOut
  }).delay(.4)),
  addScene("#section7", new TweenMax.from(".section7 #price-item2", 1.8, {
      opacity: 0,
      y: 100,
      ease: Power1.easeOut
  }).delay(.5)),
...
//   console.log("Loading scene footer"),
//   addScene("#ev-footer", new TweenMax.from(".ev-content-title span", 1, {
//       opacity: 0,
//       y: 10,
//       ease: Power1.easeOut
//   }).delay(0.2)),
//   addScene("#ev-footer", new TweenMax.from(".ev-content-title h3", 1.5, {
//       opacity: 0,
//       y: 10,
//       ease: Power1.easeOut
//   }).delay(0.2)),
//   addScene("#ev-footer", new TweenMax.from("#mailchimp-subscribe", 2, {
//       opacity: 0,
//       y: 10,
//       ease: Power1.easeOut
//   }).delay(0.2)),
